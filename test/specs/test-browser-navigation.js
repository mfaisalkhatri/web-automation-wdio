...
describe("Learning WebdriverIO - Handling Browser Navigations", () => {
    ...
    it('should get title and current url', async () => {
        ...
        await expect(currentTitle).toEqual('Selenium Grid Online | Run Selenium Test On Cloud');

        const currentUrl = await browser.getUrl();
        await expect(currentUrl).toEqual('https://www.lambdatest.com/selenium-playground/');
    });
});
